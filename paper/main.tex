...
\begin{figure}[t]
 \centering\includegraphics[width=\linewidth]{figures/certificate_model.pdf}
...
\begin{figure}[t]
\centering\includegraphics[width=\linewidth]{figures/utility_differences.pdf}
...
\begin{figure}[t]
\centering\includegraphics[width=\linewidth]{figures/test_tradeoffs.pdf}
...
\begin{figure}[t]
\centering\includegraphics[width=.95\linewidth]{figures/event_grid_effect.pdf}
...
\begin{table}[t]
\centering\small\input{tables/runtime.tex}
...
\begin{figure}[t]
\centering\includegraphics[width=\linewidth]{figures/budget_frontiers.pdf}
...
\input{tables/complete_utilities.tex}
\end{center}
...
\begin{center}\small
\input{tables/capacity_baselines.tex}
\end{center}
...
An OpenAI Codex generative-AI assistant was used to develop the formulation,
implement and test the algorithms, run the computational experiments, and draft
and revise the manuscript. Reported numerical results were produced by the
accompanying executable code using the cited public traces. The author is
responsible for the manuscript and its conclusions.
\end{document}
