...
It excludes credentials, raw datasets, local paths, private conference receipts
and execution environments. Compile `main.tex` with pdfLaTeX or Tectonic.

This package has been prepared locally. It is not itself an arXiv submission or
an arXiv identifier. Account authentication, any category endorsement and arXiv's
author/license declarations must be completed through the author's account.
No acceptance or endorsement is represented by this artifact.
